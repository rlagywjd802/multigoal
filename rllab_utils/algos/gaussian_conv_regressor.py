...
class GaussianConvRegressor(LasagnePowered):
    ...
    def __init__(
            ...
            error_file='errors__gaus_conv_regr.txt'
    ):
        """
    ...
    def fit(self, xs, ys):
        ...
        for batch in iterate_minibatches_generic(input_lst=[xs, ys], batchsize=self._batchsize, shuffle=True):
            ...
            params_before_optimization = copy.deepcopy(self._optimizer._target.get_param_values(trainable=True).astype('float64'))
            ...
            if (not math.isnan(loss_after_cur)) and \
               (not math.isinf(loss_after_cur)):
                ...
                self._optimizer._target.set_param_values(params_before_optimization, trainable=True)
                print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
                print('ERROR: Nans appear. Parameters reversed to: ', params_before_optimization)
