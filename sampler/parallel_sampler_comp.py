...
from rllab_utils.misc.utils import rollout_hide_seek, rollout_seek, rollout_debug, rollout, rollout_brownian
...
def _worker_collect_one_path(G, max_path_length, itr, normalize_reward,
    ...
    if use_hide is None:
        ...
        # path = rollout_debug(G.env, G.policies, max_path_length)
